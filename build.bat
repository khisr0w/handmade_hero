...
cl %CommonCompilerFlags% -I ..\iaca-win64 ..\src\handmade.cpp -Fmhandmade.map /LD /link -incremental:no /PDB:handmade_%VAR%.pdb -EXPORT:GameUpdateAndRender -EXPORT:GameGetSoundSamples
del lock.tmp
