...
global_var uint32 volatile EntryCompletionCount;
global_var uint32 volatile NextEntryToDo;
global_var uint32 volatile EntryCount;
work_queue_entry Entries[256];

// TODO(Khisrow): Double check the write ordering stuff on the CPU
        ...
        int ShowCode)
{
	...
	// TODO(Khisrow): Turn this into something waitable!
