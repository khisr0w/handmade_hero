...
{
	while(Queue->CompletionGoal != Queue->CompletionCount) Win32DoNextWorkQueueEntry(Queue);
...
WinMain(HINSTANCE Instance, HINSTANCE PrevInstance, LPSTR CommandLine, int ShowCode) {
	...
	Win32AddEntry(&Queue, DoWorkerWork, "String A10");
	...
	Win32AddEntry(&Queue, DoWorkerWork, "String B10");
